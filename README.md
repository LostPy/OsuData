...
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/f48258e18c3c4a93a7f65b51206e0b88)](https://app.codacy.com/gh/LostPy/OsuData?utm_source=github.com&utm_medium=referral&utm_content=LostPy/OsuData&utm_campaign=Badge_Grade) [![CodeFactor](https://www.codefactor.io/repository/github/lostpy/osudata/badge)](https://www.codefactor.io/repository/github/lostpy/osudata) [![Build Status](https://travis-ci.org/LostPy/OsuData.svg?branch=beta)](https://travis-ci.org/LostPy/OsuData)
 ...
 * `info.version_fmt` <a id="versionFormat"></a>
   ...
   * **Return:** none
   ...
   ![date_add exemple](https://github.com/LostPy/OsuData/blob/main/OsuData/example/example-version_fmt.png)
